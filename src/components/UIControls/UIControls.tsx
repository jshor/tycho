    ...
    return (
      ...
      >
        ...
        <div className="uicontrols__control uicontrols__control--target-label">
          <span
            ...
            onClick={
              ...
              this.props.openModal.bind(this, Constants.UI.ModalTypes.STATS_MODAL)
            }
          >
        ...
        <div className="uicontrols__control uicontrols__control--datetime">
          <DatePickerContainer time={this.props.time} onUpdate={this.props.changeTimeOffset} />
          <PlayPauseContainer />
        </div>
        ...
        <div className="uicontrols__control uicontrols__control--left-bar">
          <div
            ...
            onClick={
              this.props.openModal &&
              this.props.openModal.bind(this, Constants.UI.ModalTypes.ABOUT_MODAL)
            }
          ></div>
          <ZoomSlider value={this.props.zoom} onChange={this.props.changeZoom} />
