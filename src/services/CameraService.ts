...
export default class CameraService {
    ...
    static getPivotTween = (from: Vector3, to: Vector3, target: Object3D, group: Object3D, cb: () => void): any => {
        return new (TWEEN as any)
            .Tween(from)
    ...
    static setPivotPosition = (group: Object3D, { x, y, z }: { x: number; y: number; z: number }): void => {
