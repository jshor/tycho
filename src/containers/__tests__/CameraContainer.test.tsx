...
describe('Camera Container', () => {
    ...
    beforeEach(() => {
        component = shallow(
            <CameraContainer
                {...{ action, targetId: 'testPlanet', orbitalData: data, scene, ratio: 1.5 } as any}
            />
        );
    ...
    describe('componentWillUnmount()', () => {
        beforeEach(() => {
            const camera = new Camera();
            cameraContainer.controls = new Controls(camera, null as any);
        });
    ...
    describe('Prop update methods', () => {
        beforeEach(() => {
            cameraContainer.controls = new Controls(new Camera(), null as any);
        });
