...
describe('Stats Container', () => {
    let component: any;
    let statsContainer: any;

    beforeEach(() => {
        component = shallow(
            <StatsContainer
                {...{ orbitalData, targetId: 'dummyPlanet' } as any}
            />
        );
    ...
    describe('componentWillReceiveProps()', () => {
        ...
        beforeEach(() => {
            OrbitalService.getTargetByName = () => orbitalData[0] as any;
    ...
    describe('updateOrbitalStats()', () => {
        const targetId = 'earth';
        const target: any = { targetId, name: 'Earth' };
        ...
        it('should update the component state with the name of the active target orbital', () => {
            OrbitalService.getTargetByName = () => target;
            OrbitalService.getOrbitalStats = () => ({} as any);
            statsContainer.updateOrbitalStats(targetId, 1);
